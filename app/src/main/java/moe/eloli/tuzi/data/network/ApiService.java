package moe.eloli.tuzi.data.network;

import moe.eloli.tuzi.data.network.model.raw.RawActionResult;
import moe.eloli.tuzi.data.network.model.raw.RawFollowers;
import moe.eloli.tuzi.data.network.model.raw.RawFollowing;
import moe.eloli.tuzi.data.network.model.raw.RawLikeResult;
import moe.eloli.tuzi.data.network.model.raw.RawNodes;
import moe.eloli.tuzi.data.network.model.raw.RawNotifications;
import moe.eloli.tuzi.data.network.model.raw.RawReplies;
import moe.eloli.tuzi.data.network.model.raw.RawReply;
import moe.eloli.tuzi.data.network.model.raw.RawTopic;
import moe.eloli.tuzi.data.network.model.raw.RawTopics;
import moe.eloli.tuzi.data.network.model.raw.RawUnreadNotificationResult;
import moe.eloli.tuzi.data.network.model.raw.RawUploadPhoto;
