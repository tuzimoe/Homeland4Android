...
import moe.eloli.tuzi.ui.base.BaseFragment;
...
import static moe.eloli.tuzi.ui.user_user_list.UserUserListActivity.EXTRA_USER_USER_LIST_TYPE;
...
public class ProfileFragment extends BaseFragment implements ProfileContract.View, AlertDialogCaller {
    ...
    public void loadUserFavoriteTopicList() {
        if (!FastClickUtil.isFastClick()) {
            ...
            intent.putExtra(UserProfileActivity.EXTRA_USER_LOGIN_NAME, mPresenter.getProfileLoginName());
            intent.putExtra(UserTopicListActivity.EXTRA_USER_TOPIC_LIST_TYPE, "favorites");
    ...
    public void loadUserPublishTopicList() {
        if (!FastClickUtil.isFastClick()) {
            Intent intent = new Intent(getContext(), UserTopicListActivity.class);
            intent.putExtra(UserProfileActivity.EXTRA_USER_LOGIN_NAME, mPresenter.getProfileLoginName());
            intent.putExtra(UserTopicListActivity.EXTRA_USER_TOPIC_LIST_TYPE, "publish");
            getContext().startActivity(intent);
        }
    }
