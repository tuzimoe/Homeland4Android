...
public class TopicDetailViewHolder extends FlexibleViewHolder {
    ...
    public void editTopic() {
        if (!FastClickUtil.isFastClick()) {
            ...
            intent.putExtra(TopicAddEditActivity.EXTRA_TOPIC_ID, item.mTopicItem.getId());
    ...
    public void loadUserProfile() {
        if (!FastClickUtil.isFastClick()) {
            ...
            TopicDetailItem item = (TopicDetailItem) mAdapter.getItem(getFlexibleAdapterPosition());
            intent.putExtra(UserProfileActivity.EXTRA_USER_LOGIN_NAME, item.mTopicItem.getUser().getLogin());
