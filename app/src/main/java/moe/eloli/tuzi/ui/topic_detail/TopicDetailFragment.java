...
import moe.eloli.tuzi.data.network.model.adjusted.ProgressItem;
...
public class TopicDetailFragment extends BaseFragment implements TopicDetailContract.View {
    ...
    @BindView(moe.eloli.tuzi.R.id.swlContainer)
    SwipeRefreshLayout swlContainer;
    @BindView(moe.eloli.tuzi.R.id.rvTopicAndReplyList)
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(moe.eloli.tuzi.R.layout.fragment_topic_detail, container, false);
